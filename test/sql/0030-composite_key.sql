...
SELECT sys_syn_dblink.proc_table_create (
        ...
        in_table_id     => 'composite_key_table',
        out_group_id    => 'out',
        put_group_id    => 'put',
        dblink_connname => 'sys_syn_test');


SELECT * FROM processor_data.composite_key_table_claim_1();

SELECT * FROM processor_data.composite_key_table_pull_1();
...
FROM    processor_data.composite_key_table_processing_1
ORDER BY id, attributes;

SELECT * FROM processor_data.composite_key_table_process_1();

SELECT  *
FROM    composite_key_table
ORDER BY key_1,  key_2,  key_3,  key_4;

SELECT * FROM processor_data.composite_key_table_push_status_1();
